...
| `finops access-plan` | Approved assessment specification | Provider-specific read-only access request | Any validation or preflight failure |
...
7. `make check` compiles the package, runs all tests, and exercises the four CLI commands.
